...
// Force Feedback (FFB) functions
    ...
    VJOYINTERFACE_API DWORD 	__cdecl Ffb_h_Type(const FFB_DATA* Packet, enum FFBPType* Type);
    ...
    VJOYINTERFACE_API DWORD 	__cdecl Ffb_h_DevCtrl(const FFB_DATA* Packet, enum FFB_CTRL* Control);
    ...
    __declspec(deprecated("** Ffb_h_Eff_Const function was deprecated - Use function Ffb_h_CreateNewEffect **")) \
        VJOYINTERFACE_API DWORD		__cdecl Ffb_h_EffNew(const FFB_DATA* Packet, enum FFBEType* Effect);
    ...
    VJOYINTERFACE_API DWORD		__cdecl Ffb_h_CreateNewEffect(const FFB_DATA* packet, enum FFBEType* effectType, UINT* newEffectId);
